...
var meshBall3 = new THREE.Mesh(gBall2, mBall2);
...
// Floor
var gFloor = new THREE.PlaneGeometry(5, 5);
var mFloor = new THREE.MeshPhongMaterial( {color: 0x978D8D, side: THREE.DoubleSide} );
